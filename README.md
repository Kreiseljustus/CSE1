...
Since i did not use a build system you can just open the included Visual Studio 2022 Solution files in [8-bit CPU](/8-bit%20CPU/) or [8-bit CPU asm](/8-bit%20CPU%20asm/)

## Structure

The repo is divided into two projects. [8-bit CPU](/8-bit%20CPU/) includes the cpu emulation code and [8-bit CPU asm](/8-bit%20CPU%20asm/) contains the assembler.
